...
Usage
  # 지정한 체크포인트들 평균
  python avg_ckpt.py --model-dir /deepet/jh/sensevoice/finetune/pruned/workdir/sensevoice_scratch_ko5k_mcu \
                     --ckpts model.pt.ep28.10000 model.pt.ep29 model.pt.ep29.5000 \
                             model.pt.ep29.10000 model.pt.ep30

  # 디렉토리에서 최신 N개 자동 선택
  python avg_ckpt.py --model-dir .../sensevoice_scratch_ko5k_mcu --last 5
