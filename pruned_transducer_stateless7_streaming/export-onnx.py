...
def get_parser():
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="""Path to a specific .pt checkpoint file to export.
        If provided, this overrides --epoch/--iter/--avg/--use-averaged-model
        for model loading.""",
    )
...
def main():
    ...
    if params.checkpoint:
        suffix = Path(params.checkpoint).stem
    elif params.iter > 0:
    ...
    if params.use_averaged_model and not params.checkpoint:
